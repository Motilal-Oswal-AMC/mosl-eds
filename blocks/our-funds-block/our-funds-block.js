  ...
  let divfund = div(
    ...
    div(
      ...
      div(
              ...
              div(
                { class: "squareby-container grid-view-active",
                  onclick:(event)=>{
                    ...
                    event.currentTarget.closest(".right-container").querySelector(".list-view-header").style.display = "none"
                    viewFunction(block);
                  }
                 },
              ...
              div(
                { class: "listby-container",
                  onclick:(event)=>{
                    ...
                    event.currentTarget.closest(".right-container").querySelector(".list-view-header").style.display = "block"
                    viewFunction(block);
                  }
                 },
        ...
        div({class:"list-view-header", style:"display:none"},
